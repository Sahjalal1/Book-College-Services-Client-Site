...
const Cart = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-0 lg:mx-20 mt-10 ">
            ...
            {
               loading === true ? <span className="loading loading-spinner loading-lg my-auto mx-auto text-xl font-bold">loading</span> : datas.map(data => <div key={data._id} className="mx-auto w-[100%] lg:w-[100%] border-2 border-[#686666c7] px-4 py-3">
